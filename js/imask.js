(function(global, factory) {
  ...
  class HTMLMaskElement extends MaskElement {
    ...
    get rootElement() {
      ...
      return (_this$input$getRootNo = (_this$input$getRootNo2 = (_this$input = this.input).getRootNode) == null ? void 0 : _this$input$getRootNo2.call(_this$input)) != null
  ...
  class MaskedDynamic extends Masked {
    ...
    currentMaskFlags(flags) {
      ...
      return {
        ...flags,
        _beforeTailState:
          (((_flags$_beforeTailSta = flags._beforeTailState) == null ? void 0 : _flags$_beforeTailSta.currentMaskRef) === this.currentMask &&
  ...
  class RepeatBlock extends MaskedPattern {
    ...
    _appendCharRaw(ch, flags) {
      ...
      for (
        let bi =
            (_this$_mapPosToBlock$ = (_this$_mapPosToBlock = this._mapPosToBlock(this.displayValue.length)) == null ? void 0 : _this$_mapPosToBlock.index) != null
